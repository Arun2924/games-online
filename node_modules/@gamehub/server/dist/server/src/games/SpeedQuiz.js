...
exports.SpeedQuiz = void 0;
const questions_1 = require("./speedQuiz/questions");
...
exports.SpeedQuiz = {
    ...
    createState: (players) => {
        ...
        const questions = (0, questions_1.getRandomQuestions)(5);
        return {
            status: 'playing',
            winnerId: null,
            players: playerMap,
    ...
    handleAction: (state, action, playerId) => {
        ...
        if (action.type === 'submit_answer' && state.state.phase === 'playing') {
            if (state.state.playerAnswers[playerId])
